...
py::str version_full();
py::str commit();
py::dict dataset(array_double lattice, array_double positions,
                 array_int atom_types, py::int_ hall_number, py::float_ symprec,
                 py::float_ angle_tolerance);
py::dict layer_dataset(array_double lattice, array_double positions,
                       array_int atom_types, py::int_ aperiodic_dir,
                       py::float_ symprec);
py::dict magnetic_dataset(array_double lattice, array_double positions,
...
py::dict spacegroup_type_from_symmetry(array_int rotations,
                                       array_double translations,
                                       array_double lattice,
                                       py::float_ symprec);
py::dict magnetic_spacegroup_type(py::int_ uni_number);
py::dict magnetic_spacegroup_type_from_symmetry(array_int rotations,
                                                array_double translations,
                                                array_int time_reversals,
                                                array_double lattice,
                                                py::float_ symprec);
py::int_ symmetry_from_database(array_int rotations, array_double translations,
                                py::int_ hall_number);
py::int_ magnetic_symmetry_from_database(array_int rotations,
                                         array_double translations,
                                         array_int time_reversals,
                                         py::int_ uni_number,
                                         py::int_ hall_number);
py::tuple pointgroup(array_int rotations);
py::int_ standardize_cell(array_double lattice, array_double positions,
                          array_int atom_types, py::int_ num_atom,
                          py::int_ to_primative, py::int_ no_idealize,
                          py::float_ symprec, py::float_ angle_tolerance);
py::int_ refine_cell(array_double lattice, array_double positions,
                     array_int atom_types, py::int_ num_atom,
                     py::float_ symprec, py::float_ angle_tolerance);
py::int_ symmetry(array_int rotations, array_double translations,
...
py::int_ primitive(array_double lattice, array_double positions,
                   array_int atom_types, py::float_ symprec,
                   py::float_ angle_tolerance);
...
py::int_ BZ_grid_address(array_int bz_grid_address, array_size_t bz_map,
                         ...
                         array_double reciprocal_lattice, array_int is_shift);
py::int_ delaunay_reduce(array_double lattice, py::float_ symprec);
py::int_ niggli_reduce(array_double lattice, py::float_ eps);
py::int_ hall_number_from_symmetry(array_int rotations,
                                   array_double translations,
                                   py::float_ symprec);
}  // namespace spglib
